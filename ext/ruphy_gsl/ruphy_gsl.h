...
typedef gsl_complex(*spwf_func)(double r, double theta, double phi, void *params);
typedef gsl_complex(*spop_func)(double r, double theta, double phi, void *op_params, spwf_func spwf, void *wf_params);
